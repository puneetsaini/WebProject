...
<head>
  ...
  document.getElementById('une').innerHTML = "Please enter a keyword";
    ...
    <div class="container">
        ...
        <div class="row section">
            <div class="col-lg-12">
                ...
                <form action="search/process" onsubmit="return(validate())" name="searchform" id="searchform" method="post">
